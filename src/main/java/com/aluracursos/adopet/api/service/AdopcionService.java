...
public class AdopcionService {
    ...
    public void solicitar(SolicitudAdopcionDTO dto){
        ...
        emailService.enviarEmail(
                ...
                "Hola " + adopcion.getMascota().getRefugio().
                        getNombre() +"!\n\nUna solicitud de adopción" +
                        " fue registrada hoy para la mascota: "
                        + adopcion.getMascota().getNombre() +". \nPor favor, " +
                        "evaluarla para aprobación o reprobación."
                        );
    }
    ...
    public void  aprobar(AprobacionAdopcionDTO dto){
        ...
        emailService.enviarEmail(
                ...
                "Felicitaciones " + adopcion.getTutor().getNombre()
                        ...
                        + adopcion.getMascota().getRefugio().getNombre()
                        +" para ir a buscar a su mascota."
        );
    ...
    public void reprobar(ReprobacionAdopcionDTO dto){
        ...
        emailService.enviarEmail(
                ...
                "Hola " + adopcion.getTutor().getNombre() +"!\n\nInfelizmente su adopción de la mascota "
                        + adopcion.getMascota().getNombre() +", solicitada el dia "
                        + adopcion.getFecha().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
                        +", fue reprobada por el refugio "
                        + adopcion.getMascota().getRefugio().getNombre() +" con la seguiente justificativa: "
                        + adopcion.getJustificacionStatus()
        );
    }
}
